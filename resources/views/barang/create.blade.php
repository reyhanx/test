...
@section('content') 
    ...
    old('barang_nama') }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="harga_beli" class="form-control" id="harga_beli" name="harga_beli" value="{{ 
    old('harga_beli') }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="harga_jual" class="form-control" id="harga_jual" name="harga_jual" value="{{ 
